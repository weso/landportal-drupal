...
var optionScatterPlot = {
	...
	var correlate = document.getElementById('correlate-chart');
	optionScatterPlot.width = correlate.offsetWidth;
	optionScatterPlot.height = correlate.offsetHeight;
	
	var chart = wesCountry.charts.scatterPlot(optionScatterPlot);
	correlate.appendChild(chart.render());