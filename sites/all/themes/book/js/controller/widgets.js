...
function generateDownloadLinks(chart) {
	...
	document.getElementById('png-link').href = canvas.toDataURL("image/png");
	document.getElementById('jpg-link').href = canvas.toDataURL("image/jpg");
	document.getElementById('gif-link').href = canvas.toDataURL("image/gif");
