...
function render_mustache($mustache_data, $mustache_template, $mustache_navigation, $application_data, $theme_path) {
...
function get_mustache($views_path, $partials_path) {
	require_once libraries_get_path('Mustache') . '/Autoloader.php';
	$theme_path = drupal_get_path('theme', 'book');
